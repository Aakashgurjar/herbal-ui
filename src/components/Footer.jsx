...
const Footer = () => {
  return (
    ...
    <footer className="bg-[#002209] text-white border-t border-blue-200 pt-10 pb-4 px-2 md:px-16 max-w-11/12 mx-auto">
    ...
    <div className="max-w-7xl mx-auto font-semibold flex flex-row justify-between items-center text-sm px-1 gap-2 sm:gap-0">
      <p className="text-[0.6rem] sm:text-xs md:text-sm">© 2025 HERBA ESSENTIAL. All Rights Reserved.</p>
